...
cd /tmp/
rm sql.sql
mv -f /new_app/index.php /app/
cp -f /app/index.php /app/index.php~
mv -f /new_app/user.php /app/
cp -f /app/user.php /app/user.php~
mv -f /new_app/static/piapiapia.gif /app/static/
mv -f /new_app/views/* /app/views/
mkdir /app/upload
chown www-data:www-data /app/upload -R
